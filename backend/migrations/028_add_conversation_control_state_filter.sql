...
-- Optional control_state filter on the seller conversation list
-- read model.
--
-- This migration is read-model only. It does not change conversation
-- control transitions, RLS, or tenant scoping. The 4-argument
-- function is dropped first so PostgreSQL does not keep an
-- overloaded signature that would make 3-arg / defaulted calls
-- ambiguous against the new 5-argument function.
-- ============================================================
...
VALUES (
    '028',
    'add_conversation_control_state_filter',
    'conversation_control_state_filter_v1',
    CURRENT_USER
)
