-- ============================================================
-- 051_repair_guarded_auto_reply_signature.sql
-- 045 defined ai_confidence_value as REAL. Migration 050 accidentally used
-- DOUBLE PRECISION, which created an overload instead of replacing the existing
-- RPC. Remove the accidental overload and install the dispatch-control snapshot
-- behavior on the original REAL signature so PostgREST has one authoritative
-- function contract.
-- ============================================================

BEGIN;

DROP FUNCTION IF EXISTS public.persist_guarded_auto_reply(
...
VALUES (
    '051',
    'repair_guarded_auto_reply_signature',
    'repair_guarded_auto_reply_signature_v1',
    CURRENT_USER
)
