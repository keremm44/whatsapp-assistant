  ...
  return (
    <div className="w-full sm:w-56">
      ...
      <select
        ...
        aria-busy={isPending}
        className="h-11 w-full rounded-md border border-border bg-control px-3 text-sm sm:h-10 text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
