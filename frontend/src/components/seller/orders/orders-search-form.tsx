    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          aria-busy={isPending}
          className="h-11 w-full rounded-md border border-border bg-control pl-9 pr-9 sm:h-10 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        />
        {value.trim().length > 0 ? (
          <button
            type="button"
