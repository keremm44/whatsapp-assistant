                  ...
                  <div className="flex flex-col gap-1.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                    ...
                    <div className="flex shrink-0 items-center gap-2">
                      <select
                        ...
                        className="h-11 w-full rounded-md border border-border bg-surface px-3 text-sm sm:h-10 text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-50 sm:w-52"
                      >
