 ...
 * read as a live chat. One primary action (application), one secondary
 * (the demo), and the existing-seller path lives in the header.
 */
    ...
    <section className="mx-auto grid w-full max-w-[1180px] gap-12 px-4 pb-16 pt-14 md:px-6 md:pt-20 lg:grid-cols-[minmax(0,1fr)_400px] lg:items-center lg:gap-10 lg:px-8 lg:pb-20">
      <div className="flex flex-col items-start gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <a
            href="#basvur"
            className="rounded-control bg-primary-button px-5 py-3 text-base font-medium text-primary-foreground transition-colors hover:bg-primary-button-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Başvuru yap
          </a>
          <a
            href="#dene"
            className="rounded-control border border-border bg-surface px-5 py-3 text-base font-medium text-foreground transition-colors hover:bg-recessed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Konuşmasını görün
          </a>
        </div>
